...
1. We will start with a simple 1PL-Model. First we have to estimate the person parameters. Here we have to choose an estimation method. It is important, that you can only choose **mle, wle or map** for the LZ and LZ* Index. For the Infit-Outfit statistic we support the **mle and wle** estimates.
