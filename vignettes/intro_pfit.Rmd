...
title(main="Density plot of lz* person parameter", xlab="density", ylab="score")
...
plot(avg, x,
     ...
     pch=19, ylab="Persons", xlab="Person-Fit +/- SD",
     main="Plot of person fit with error bars"
)
arrows(avg-sdev, x, avg+sdev, length=0.05, angle=90, code=3)
abline(v=mean(avg),col = "red", lwd = 3)
```